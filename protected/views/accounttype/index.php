...
<?php echo CHtml::ajax(array(
            ...
            'success'=>"function(data)
            {
                ...
                {
$('#Accounttype_accounttypeid').val('');$('#Accounttype_accounttypename').val('');
...
<?php echo CHtml::ajax(array(
            ...
            'success'=>"function(data)
            {
                if (data.status == 'success')
                {
$('#Accounttype_accounttypeid').val(data.accounttypeid);$('#Accounttype_accounttypename').val(data.accounttypename);
...
function downloaddata(value) {
	window.open('index.php?r=accounttype/download&id='+value);
}
</script>
