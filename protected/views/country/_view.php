...
<div class="rowdata">
    ...
    <span class="cellcontent"><?php echo $model->countryid;?></span>
</div>
<div class="rowdata">
	<span class="cell">Country Code</span>
    <span class="cellcontent"><?php echo $model->countrycode;?></span>
</div>
<div class="rowdata">
	<span class="cell">Country Name</span>
    <span class="cellcontent"><?php echo $model->countryname;?></span>
</div>
<div class="rowdata">
