...
<div class="rowdata">
    ...
    <span class="cell"><input type="text" name="search_countrycode" id="search_countrycode"></span>
</div>
<div class="rowdata">
	<span class="cell">Country Name</span>
    <span class="cell"><input type="text" name="search_countryname" id="search_countryname"></span>
</div>
<div class="rowdata">
<span class="cell">
<?php
