...
<div class="rowdata">
    ...
    <span class="cell"><?php echo $model->productid;?></span>
</div>
<div class="rowdata">
	<span class="cell">Product</span>
    <span class="cell"><?php echo $model->productname;?></span>
</div>
<div class="rowdata">
	<span class="cell">Is Stock</span>
    <span class="cell"><?php echo ($model->isstock==1)?Catalogsys::model()->getcatalog("stock"):Catalogsys::model()->getcatalog("notstock");?></span>
</div>
<div class="rowdata">
