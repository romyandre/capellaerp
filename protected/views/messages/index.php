...
function adddata()
{
    <?php echo CHtml::ajax(array(
            ...
            'success'=>"function(data)
            {
                ...
                {
					$('#Messages_messagesid').val('');
					$('#Messages_messagename').val('');
					$('#Messages_description').val('');
...
function editdata(value)
{
	...
	echo CHtml::ajax(array(
            ...
            'success'=>"function(data)
            {
                if (data.status == 'success')
                {
					$('#Messages_messagesid').val(data.messagesid);
					$('#Messages_messagename').val(data.messagename);
					$('#Messages_description').val(data.description);
...
function downloaddata(value) {
	window.open('index.php?r=messages/download&id='+value);
}
</script>
