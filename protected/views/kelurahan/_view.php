...
<div class="rowdata">
    ...
    <span class="cellcontent"><?php echo $model->kelurahanid;?></span>
</div>
<div class="rowdata">
	<span class="cell">Sub Subdistrict</span>
    <span class="cellcontent"><?php echo $model->kelurahanname;?></span>
</div>
<div class="rowdata">
	<span class="cell">Subdistrict</span>
    <span class="cellcontent"><?php echo ($model->subdistrict!==null)?$model->subdistrict->subdistrictname:'';?></span>
</div>
