...
<div class="rowdata">
    ...
    <span class="cell"><input type="text" name="search_paramname" id="search_paramname"></span>
	<span class="cell">Parameter Value</span>
    <span class="cell"><input type="text" name="search_paramvalue" id="search_paramvalue"></span>
</div>
<div class="rowdata">
<span class="cell">
<?php
