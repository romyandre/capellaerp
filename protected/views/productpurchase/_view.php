...
<div class="rowdata">
    ...
    <span class="cellcontent"><?php echo $model->productpurchaseid;?></span>
</div>
<div class="rowdata">
...
<div class="rowdata">
    ...
    <span class="cellcontent"><?php echo ($model->plant!==null)?$model->plant->description:'';?></span>
</div>
<div class="rowdata">
	<span class="cell">Order Unit</span>
    <span class="cellcontent"><?php echo ($model->orderunit0!==null)?$model->orderunit0->description:'';?></span>
</div>
<div class="rowdata">
