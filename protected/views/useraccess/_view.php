...
<div class="rowdata">
    ...
    <span class="cellcontent"><?php echo $model->useraccessid;?></span>
</div>
<div class="rowdata">
	<span class="cell">Real Name</span>
    <span class="cellcontent"><?php echo $model->realname;?></span>
</div>
<div class="rowdata">
	<span class="cell">User Name</span>
    <span class="cellcontent"><?php echo $model->username;?></span>
</div>
<div class="rowdata">
...
<div class="rowdata">
    ...
    <span class="cellcontent"><?php echo $model->theme?></span>
</div>
<div class="rowdata">
	<span class="cell">Background</span>
    <span class="cellcontent"><?php echo $model->background?></span>
</div>
<div class="rowdata">
