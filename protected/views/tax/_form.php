...
<span class="cell"><?php echo $form->labelEx($model,'taxcode'); ?></span>
		<span class="cell"><?php echo $form->textField($model,'taxcode',array('size'=>20,'maxlength'=>20)); ?></span>
	</div>

		<div class="rowdata">
		<span class="cell"><?php echo $form->labelEx($model,'taxvalue'); ?></span>
		<span class="cell"><?php echo $form->textField($model,'taxvalue',array('size'=>5,'maxlength'=>5)); ?> %</span>
	</div>
