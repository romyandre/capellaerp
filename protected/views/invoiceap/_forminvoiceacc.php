...
$currency=new Currency('searchwstatus');
    ...
    $this->endWidget('zii.widgets.jui.CJuiDialog');
    echo CHtml::Button('...',
                          array('onclick'=>'$.fn.yiiGridView.update("invacccurrency-grid");$("#invacccurrency_dialog").dialog("open"); return false;',
                       ))?>
	...
	<table>
      <tr>
		...
		array('invoiceap/writeinvoiceacc'),
	  array(
	  'success'=>'function(data)
		...
		array('invoiceap/cancelwriteinvoiceacc'),
	  array(
	  'success'=>'function(data)
		{
			var x = eval("(" + data + ")");
