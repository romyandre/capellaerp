...
<div class="rowdata">
    ...
    <span class="cellcontent"><?php echo $model->paymentmethodid;?></span>
</div>
<div class="rowdata">
	<span class="cell">Payment Code</span>
    <span class="cellcontent"><?php echo $model->paycode;?></span>
</div>
<div class="rowdata">
	<span class="cell">Pay Days</span>
    <span class="cellcontent"><?php echo $model->paydays;?></span>
</div>
<div class="rowdata">
	<span class="cell">Payment Name</span>
    <span class="cellcontent"><?php echo $model->paymentname;?></span>
</div>
<div class="rowdata">
