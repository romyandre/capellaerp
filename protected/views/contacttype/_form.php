...
<?php echo $form->hiddenField($model,'contacttypeid'); ?>
	<div id="tabledata">
<div class="rowdata">
<span class="cell"><?php echo $form->labelEx($model,'contacttypename'); ?></span>
		<span class="cell"><?php echo $form->textField($model,'contacttypename',array('size'=>50,'maxlength'=>50)); ?></span>
	</div>
