...
<div class="rowdata">
    ...
    <span class="cellcontent"><?php echo $model->currencyid;?></span>
</div>
<div class="rowdata">
	<span class="cell">Country</span>
    <span class="cellcontent"><?php echo ($model->country!==null)?$model->country->countryname:'';?></span>
</div>
<div class="rowdata">
	<span class="cell">Currency</span>
    <span class="cellcontent"><?php echo $model->currencyname;?></span>
</div>
<div class="rowdata">
	<span class="cell">Symbol</span>
    <span class="cellcontent"><?php echo $model->symbol;?></span>
</div>
<div class="rowdata">
