...
function adddata()
{
   <?php echo CHtml::ajax(array(
            ...
            'success'=>"function(data)
            {
                ...
                {
$('#Addressbook_addressbookid').val('');$('#Addressbook_fullname').val('');
...
function editdata(value)
{
 <?php echo CHtml::ajax(array(
            ...
            'success'=>"function(data)
            {
                if (data.status == 'success')
                {
$('#Addressbook_addressbookid').val(data.addressbookid);$('#Addressbook_fullname').val(data.fullname);if(data.iscustomer=='1')
...
{document.forms[0].elements[15].checked=true;}
else
{document.forms[0].elements[15].checked=false;}
if(data.iscatering=='1')
{document.forms[0].elements[17].checked=true;}
else
{document.forms[0].elements[17].checked=false;}
if(data.recordstatus=='1')
{document.forms[0].elements[19].checked=true;}
else
...
function downloaddata(value) {
	window.open('index.php?r=addressbook/download&id='+value);
}
</script>
