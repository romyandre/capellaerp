...
<div class="rowdata">
		...
		<span class="cell"><?php echo ($model->iscustomer=='1')?'V':''; ?></span>
	</div>

	<div class="rowdata">
		<span class="cell">Is Employee</span>
		<span class="cell"><?php echo ($model->isemployee=='1')?'V':''; ?></span>
	</div>

	<div class="rowdata">
		<span class="cell">Is Applicant</span>
		<span class="cell"><?php echo ($model->isapplicant=='1')?'V':''; ?></span>
	</div>

	<div class="rowdata">
		<span class="cell">Is Vendor</span>
		<span class="cell"><?php echo ($model->isvendor=='1')?'V':''; ?></span>
	</div>

	<div class="rowdata">
		<span class="cell">Is Insurance</span>
		<span class="cell"><?php echo($model->isinsurance=='1')?'V':''; ?></span>
	</div>

	<div class="rowdata">
		<span class="cell">Is Bank</span>
		<span class="cell"><?php echo ($model->isbank=='1')?'V':''; ?></span>
	</div>

	<div class="rowdata">
		<span class="cell">Is Hospital</span>
		<span class="cell"><?php echo ($model->ishospital=='1')?'V':''; ?></span>
	</div>

		<div class="rowdata">
		<span class="cell">Is Catering</span>
		<span class="cell"><?php echo ($model->iscatering=='1')?'V':''; ?></span>
	</div>
