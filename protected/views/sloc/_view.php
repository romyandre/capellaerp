...
<div class="rowdata">
    ...
    <span class="cell"><?php echo $model->slocid;?></span>
</div>
<div class="rowdata">
	<span class="cell">Plant</span>
    <span class="cell"><?php echo ($model->plant!==null)?$model->plant->plantcode:'';?> - <?php echo ($model->plant!==null)?$model->plant->description:'';?></span>
</div>
<div class="rowdata">
	<span class="cell">Sloc Code</span>
    <span class="cell"><?php echo $model->sloccode;?></span>
</div>
<div class="rowdata">
