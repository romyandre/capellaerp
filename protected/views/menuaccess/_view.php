...
<div class="rowdata">
    ...
    <span class="cellcontent"><?php echo $model->menuaccessid;?></span>
</div>
<div class="rowdata">
	<span class="cell">Menu Code</span>
    <span class="cellcontent"><?php echo $model->menucode;?></span>
</div>
<div class="rowdata">
	<span class="cell">Menu Name</span>
    <span class="cellcontent"><?php echo $model->menuname;?></span>
</div>
<div class="rowdata">
	<span class="cell">Menu Url</span>
    <span class="cellcontent"><?php echo $model->menuurl;?></span>
</div>
<div class="rowdata">
	<span class="cell">Icon</span>
    <span class="cellcontent"><img style="width:24px;height:24px" src="<?php echo Yii::app()->request->baseUrl.'/images/'.$model->menuicon;?>"></span>
</div>
<div class="rowdata">
