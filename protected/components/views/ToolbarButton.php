<div id=<?php echo $this->cssToolbar ?>>
<ul>
	<?php
	...
	if ($this->isApprove == true) {
		...
		echo CHtml::link($imgapprove,'#',array(
		   'style'=>'cursor: pointer; text-decoration: underline;',
		   'onclick'=>"{". $this->UrlApprove . "(".$this->id.")}",
			'id'=>'refresh',
	...
	if ($this->isDelete == true) {
		...
		echo CHtml::link($imgdelete,'#',array(
		   'style'=>'cursor: pointer; text-decoration: underline;',
		   'onclick'=>"{". $this->UrlDelete . "(".$this->id.")}",
			'id'=>'delete',
...
<img src="images/up.png" alt="">
	...
	if ($this->isDownload == true) {
		...
		echo CHtml::link($imgdown,'#',array(
		   'style'=>'cursor: pointer; text-decoration: underline;',
			'onclick'=>"{". $this->UrlDownload . "(".$this->id.")}",
			'id'=>'download',
