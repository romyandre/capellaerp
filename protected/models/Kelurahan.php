...
class Kelurahan extends CActiveRecord
{
	...
	{
		if (isset($_GET['kelurahanname']))
{
	$criteria->compare('kelurahanname',$_GET['kelurahanname'],true);
}
		if (isset($_GET['subdistrictname']))
{
	$criteria->compare('subdistrict.subdistrictname',$_GET['subdistrictname'],true);
}
}
