 ...
 * @property SupplierAddressbook $addressbook
 * @property City $city
 * @property Subdistrict $subdistrict
 * @property SupplierAddresstype $addresstype
 */
class Supplieraddress extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Supplieraddress the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
            ...
            array('phoneno,faxno', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('addressid, addressbookid, addresstypeid, addressname, rt, faxno,rw, cityid, kelurahanid, subdistrictid, phoneno', 'safe', 'on'=>'search'),
		);
	}
...
$criteria->condition='addressbook.isvendor=1 and t.addressbookid='.$_GET['Supplieraddress']['addressbookid'];
} else {
