...
class Suppliercontact extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'addressbook' => array(self::BELONGS_TO, 'Supplier', 'addressbookid'),
...
$criteria->condition='addressbook.isvendor=1 and t.addressbookid='.$_GET['Suppliercontact']['addressbookid'];
} else {
