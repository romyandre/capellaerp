...
class Addressbook extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('iscustomer, isemployee, isapplicant, isvendor, isinsurance, isbank, ishospital, recordstatus', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			'addresses' => array(self::HAS_MANY, 'Address', 'addressbookid'),
			'addresscontacts' => array(self::HAS_MANY, 'Addresscontact', 'addressbookid'),
			'bankaccounts' => array(self::HAS_MANY, 'Bankaccount', 'bankid'),
			'employees' => array(self::HAS_MANY, 'Employee', 'addressbookid'),
			'voucheragents' => array(self::HAS_MANY, 'Voucheragent', 'addressbookid'),
			'warnetmembers' => array(self::HAS_MANY, 'Warnetmember', 'addressbookid'),
		);
	}
