...
class Productbasic extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('productid, baseuom, materialgroupid', 'required'),
			array('productid, baseuom, materialgroupid, weightunit, volumeunit, materialpackage, recordstatus', 'numerical', 'integerOnly'=>true),
		...
		if (isset($_GET['productname']))
{
	...
	public function search()
	{
		...
		$criteria->compare('baseuom0.uomcode',$this->baseuom,true);
		...
		$criteria->compare('baseuom1.weightunit',$this->weightunit,true);
		$criteria->compare('netweight',$this->netweight,true);
		$criteria->compare('volume',$this->volume,true);
		$criteria->compare('baseuom2.volumeunit',$this->volumeunit,true);
