...
{
	$criteria->compare('accounttypename',$_GET['accounttypename'],true);
}
		if (isset($_GET['parentaccounttypename']))
{
	$criteria->compare('parentaccounttype.accounttypename',$_GET['parentaccounttypename'],true);
}
}
