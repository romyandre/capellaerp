...
class Materialgroup extends CActiveRecord
{
	...
	{
		if (isset($_GET['materialgroupcode']))
{
	$criteria->compare('materialgroupcode',$_GET['materialgroupcode'],true);
}
if (isset($_GET['description']))
{
	$criteria->compare('description',$_GET['description'],true);
}
if (isset($_GET['materialtypecode']))
{
	$criteria->compare('materialtype.materialtypecode',$_GET['materialtypecode'],true);
}
if (isset($_GET['materialtypedesc']))
{
	$criteria->compare('materialtype.description',$_GET['materialtypedesc'],true);
}
}
