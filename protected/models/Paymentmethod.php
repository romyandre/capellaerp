...
{
	$criteria->compare('paycode',$_GET['paycode'],true);
}
if (isset($_GET['paymentname']))
{
	$criteria->compare('paymentname',$_GET['paymentname'],true);
}
if (isset($_GET['paydays']))
{
	$criteria->compare('paydays',$_GET['paydays'],true);
}
}
