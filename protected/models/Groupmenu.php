...
class Groupmenu extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('groupmenuid, groupaccessid, menuaccessid, isread, iswrite, ispost, isreject, isupload, isdownload', 'safe', 'on'=>'search'),
		);
	}
...
{
	$criteria->compare('menuaccess.description',$_GET['menuname'],true);
}
	}
